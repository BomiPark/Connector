			...
			<div class="footer">
				<div class="sitemap">
					...
					<div class="row" style="padding-left: 60px;">
						...
						<div class="col-md-3 col-xs-3 col-sm-3 col-lg-3 sitemap">
							<a href="list_all.html">TEAM</a><br> 
							<a href="list_roco.html">전체 보기</a><br> 
							<a href="list_horror.html">마감임박팀</a><br> 
							<a href="list_etc.html">Marketing</a><br> 
							<a href="list_etc.html">Develop</a><br> 
							<a href="list_etc.html">Plan</a><br>
							<a href="">Culture</a>
						</div>
						<div class="col-md-3 col-xs-3 col-sm-3 col-lg-3 sitemap">
							<a href="board.jsp">PEOPLE</a><br>
						</div>
						<div class="col-md-3 col-xs-3 col-sm-3 col-lg-3 sitemap">
