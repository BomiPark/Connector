...
function contest_save() {
	...
	form.command.value = "contestCreate";
	form.action = "contest_create.m2";
	form.submit();
	...
	<div class="row">
		...
		<div class="col-md-8 col-xs-8 col-sm-8 col-lg-8">
			...
			<div class="margin_bottom">
				<span class="btitle"> 공모전 추가 </span> <br>
				<span class="bcontent">관리자 권한으로 공모전을 추가해 주세요.</span>
			<hr>
			</div>
			...
			<input type="hidden"
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" name="contestTitle" id="contest_board_title" placeholder="title">
			    </div>
			  </div> 
			  <div class="form-group">
				  ...
				  <label class="radio-inline">
				  	<input type="radio" name="subjectName" id="inlineRadio2" value="Develop"> Develop
				  </label>
				  <label class="radio-inline">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <textarea class="form-control" rows="10" name="contestContent" placeholder="contest_content"></textarea>
			    </div>
			  </div>
			  <div class="form-group">
			    <label for="startDay" class="col-sm-2">시작일</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" name="startDay" id="contest_startday" placeholder="contest_startday">
			    </div>
			  </div>
			  <div class="form-group">
			    <label for="contest_endday" class="col-sm-2">마감일</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" name="endDay" id="contest_endday" placeholder="contest_endday">
			    </div>
			  </div>
 			  <input type="button" value="저장" class="btn sbtn" style="float:right" onClick="contest_save()"> &nbsp;
			</form>
